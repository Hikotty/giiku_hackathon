...
class HintPlaceViewController: UIViewController {
    ...
    let storeImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "shop_name_temp")
        return imageView
    }()
    ...
    let imageButton: UIButton = {
        ...
        button.addTarget(HintPlaceViewController.self, action: #selector(imageButtonTapped), for: .touchUpInside)
        return button
    }()
